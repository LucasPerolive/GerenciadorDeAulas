...
<div class="jumbotron">
    ...
    <div class="alert alert-dark"   >
        <h1 class="display-3">Formulário de cadastro de Professores</h1>
    </div>
</div>
   
    <?php

    include 'Visao/Professores/FormCadProfessor.php';
    include 'Visao/Professores/ListarProfessor.php';
    ?>
